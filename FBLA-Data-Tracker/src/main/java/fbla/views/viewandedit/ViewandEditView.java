package fbla.views.viewandedit;

import org.springframework.beans.factory.annotation.Autowired;

import fbla.backend.BackendService;
...
@Route(value = "view-edit", layout = MainView.class)
@PageTitle("View and Edit")
@CssImport("./styles/views/viewandedit/viewand-edit-view.css")
public class ViewandEditView extends Div implements AfterNavigationObserver {
    ...
    public ViewandEditView() {
        setId("viewand-edit-view");
        // Configure Grid
        employees = new Grid<>();
