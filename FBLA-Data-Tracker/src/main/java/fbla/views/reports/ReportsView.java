...
@PageTitle("Reports")
@CssImport(value = "./styles/views/reports/reports-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class ReportsView extends Div implements AfterNavigationObserver {
